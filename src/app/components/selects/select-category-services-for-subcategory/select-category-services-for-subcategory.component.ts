...
@Component({
  selector: 'app-select-category-services-for-subcategory',
  templateUrl: './select-category-services-for-subcategory.component.html',
  styles: [
  ]
})
export class SelectCategoryServiceForSubcategoryComponent implements OnInit {

  @ViewChild(NgSelectComponent) ngSelectComponent!:NgSelectComponent;

  loading:boolean = false;

  @Input() categoriesServicesSelected!:(string | undefined)[];
  ...
  @Output() changecategoriesServices:EventEmitter<(string | undefined)[]> = new EventEmitter<(string | undefined)[]>();
  ...
  clear(){
    this.categoriesServicesSelected = [];
  }
